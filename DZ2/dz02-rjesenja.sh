...
sort -n --output=korisnici.sortirano.dat korisnici.dat 
...
# insensitive. (1.0)
cut -f2 -d: korisnici.sortirano.dat | sort | uniq -i --unique > jedinstveni_korisnici.dat
...
# insensitive. (1.0)
cut -f2 -d: korisnici.sortirano.dat | sort | uniq -i -d > nejedinstveni_korisnici.dat
...
# ping. (0.5)
grep -o 'ping' /usr/share/dict/words | wc -w
#u ovom slučaju smo mogli i grep -c 'ping' /usr/share/dict/words
